...
def listeClient(user,s):
    ...
    afficher.add_command(label="Client",state="disabled")  
    ...
    titre=Label(topFrame,text="LISTE CLIENTS",bg = '#38184c',fg="white",font=('Poppins Bold',25))
    logo=Label(topFrame,text="EMSI STOCK",bg = '#38184c',fg="white",font=('Poppins Bold',25))
    logo.place(x=10,y=2)
    titre.place(x=675,y=0)
